(function (_, Kotlin, $module$react, $module$kotlin_extensions) {
  ...
  RBuilder.prototype.child_ops9p9$ = defineInlineFunction('kotlin-react.react.RBuilder.child_ops9p9$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (C_0, isC, handler) {
      return this.child_drr62v$(getKClass(C_0), handler);
    };
  }));
  ...
  RBuilder.prototype.node_347wp$ = defineInlineFunction('kotlin-react.react.RBuilder.node_347wp$', wrapFunction(function () {
    ...
    return function (C_0, isC, props, children) {
      if (children === void 0)
        children = emptyList();
      return this.node_nvhxy3$(getKClass(C_0), props, children);
    };
  }));
  RBuilder.prototype.children_yllgzm$ = function ($receiver) {
    addAll(this.childList, React$Children.toArray(get_children($receiver)));
  };
  RBuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'RBuilder',
  ...
  function Fragment$lambda(props) {
  ...
  function buildElements(handler) {
    ...
    if (nodes.size === 0)
      ...
      var tmp$_1 = (tmp$ = $module$react).createElement;
      var tmp$_2 = Fragment;
      var obj = {};
      tmp$_0 = tmp$_1.apply(tmp$, [tmp$_2, obj].concat(copyToArray(nodes)));
    }
    return tmp$_0;
  }
  ...
  Object.defineProperty(package$react, 'Fragment', {
    get: function () {
      return Fragment;
    }
  });
  ...
  var tmp$, tmp$_0;
  Fragment = (tmp$_0 = $module$react.Fragment) != null ? tmp$_0 : Kotlin.isType(tmp$ = Fragment$lambda, Object) ? tmp$ : throwCCE();
