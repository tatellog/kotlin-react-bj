...
(function (_, Kotlin, $module$typescript, $module$path, $module$fs, $module$process) {
  ...
  function Stringify$visitType$lambda$lambda(it) {
    var tmp$, tmp$_0;
    return it.name + stringify(it.type) + toString((tmp$_0 = (tmp$ = it.defaultValue) != null ? ' /*= ' + tmp$ + '*/' : null) != null ? tmp$_0 : '');
  }
  Stringify.prototype.visitType_yasija$ = function (type) {
    ...
    if (callSignature != null) {
      ...
      this.out_0.print_61zpoe$(!type.isLambda ? get_escapedName(type) : type.name);
      this.acceptForEach_0(type.typeArgs, this, ', ', '<', '>');
    }
    if (type.isNullable && !equals(type.name, DYNAMIC)) {
      this.out_0.print_61zpoe$('?');
    }
  ...
  Stringify.prototype.visitHeritageType_dup87$ = function (heritageType) {
    this.out_0.print_61zpoe$(heritageType.name);
  };
  ...
  KtAnnotation.prototype.copy_r7lf1y$ = function (name, parameters) {
  ...
  KtClassifier.prototype.copy_h6nz6n$ = function (kind, name, paramsOfConstructors, typeParams, parents, members, annotations, hasOpenModifier) {
  ...
  KtFunParam.prototype.copy_mgz5iw$ = function (name, type, defaultValue, isVar) {
  ...
  KtFunction.prototype.copy_xvy9yo$ = function (name, callSignature, extendsType, annotations, needsNoImpl, isOverride, hasOpenModifier, isOperator) {
  ...
  KtVariable.prototype.copy_nbsl0f$ = function (name, type, extendsType, annotations, typeParams, isVar, needsNoImpl, isInInterface, isOverride, hasOpenModifier) {
  ...
  KtEnumEntry.prototype.copy_jyasbz$ = function (name, value) {
  ...
  KtHeritageType.prototype.copy_61zpoe$ = function (name) {
    return new KtHeritageType(name === void 0 ? this.name : name);
  };
  KtHeritageType.prototype.toString = function () {
    return 'KtHeritageType(name=' + Kotlin.toString(this.name) + ')';
  };
  ...
  function KtType(name, typeArgs, comment, isNullable, callSignature) {
    if (typeArgs === void 0)
      typeArgs = emptyList();
    if (comment === void 0)
      comment = null;
  ...
  KtType.prototype.isUnit = function () {
    return equals(get_escapedName(this), UNIT) && !this.isNullable && !this.isLambda;
  };
  KtType.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'KtType',
  ...
  KtType.prototype.copy_x1fyqk$ = function (name, typeArgs, comment, isNullable, callSignature) {
    return new KtType(name === void 0 ? this.name : name, typeArgs === void 0 ? this.typeArgs : typeArgs, comment === void 0 ? this.comment : comment, isNullable === void 0 ? this.isNullable : isNullable, callSignature === void 0 ? this.callSignature : callSignature);
  };
  KtType.prototype.toString = function () {
    return 'KtType(name=' + Kotlin.toString(this.name) + (', typeArgs=' + Kotlin.toString(this.typeArgs)) + (', comment=' + Kotlin.toString(this.comment)) + (', isNullable=' + Kotlin.toString(this.isNullable)) + (', callSignature=' + Kotlin.toString(this.callSignature)) + ')';
  };
  ...
  KtType.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.name, other.name) && Kotlin.equals(this.typeArgs, other.typeArgs) && Kotlin.equals(this.comment, other.comment) && Kotlin.equals(this.isNullable, other.isNullable) && Kotlin.equals(this.callSignature, other.callSignature)))));
  };
  ...
  KtTypeParam.prototype.copy_i3aw77$ = function (name, upperBound) {
  ...
  function createFunctionType(parameters, returnType, isNullable) {
    if (isNullable === void 0)
      isNullable = false;
    return new KtType('Function', void 0, void 0, isNullable, new KtCallSignature(parameters, null, new KtTypeAnnotation(returnType)));
  }
  function Visitor() {
  }
  ...
  function isIdentifier($receiver) {
    ...
    all$break: do {
      var tmp$;
      tmp$ = iterator($receiver_0);
      while (tmp$.hasNext()) {
        var element = unboxChar(tmp$.next());
        if (!isIdentifierPart(unboxChar(toBoxedChar(element)))) {
          all$result = false;
          break all$break;
        }
      }
  ...
  function toKotlinParam_0($receiver, nodeType, typeWithoutFlags) {
    return toKotlinParam_1($receiver, typeWithoutFlags.copy_x1fyqk$(void 0, void 0, void 0, $receiver.questionToken != null || typeWithoutFlags.isNullable));
  }
  ...
  function toKotlinType_2($receiver, typeMapper) {
    ...
    if (equals(tmp$_0, SyntaxKind$AnyKeyword))
      ...
      tmp$_1 = new KtType(unescapeIdentifier($receiver.text));
    }
  ...
  function toKotlinTypeName($receiver) {
    ...
    if (equals(Kotlin.isType(tmp$ = $receiver.kind, Any) ? tmp$ : throwCCE(), SyntaxKind$Identifier)) {
      tmp$_2 = unescapeIdentifier((Kotlin.isType(tmp$_0 = $receiver, Object) ? tmp$_0 : throwCCE()).text);
    }
     else {
      tmp$_2 = toKotlinTypeName((Kotlin.isType(tmp$_1 = $receiver, Object) ? tmp$_1 : throwCCE()).left) + '.' + unescapeIdentifier($receiver.right.text);
    }
    return tmp$_2;
  }
  ...
  function toKotlinTypeUnion_2($receiver, typeMapper) {
    ...
    if (possibleTypes.size === 2) {
      ...
      if (t != null) {
        return new KtTypeUnion_0(listOf(t.copy_x1fyqk$(void 0, void 0, void 0, true)));
      }
    }
  ...
  function toKotlinTypeUnion$lambda(closure$commentWithExpectedType) {
    return function (it) {
      return it.copy_x1fyqk$(void 0, void 0, closure$commentWithExpectedType);
    };
  }
  ...
  function toKotlinType_4($receiver, typeMapper) {
    ...
    while (parent != null) {
      ...
      if (equals(tmp$_0, SyntaxKind$ClassDeclaration) || equals(tmp$_0, SyntaxKind$InterfaceDeclaration)) {
        return toKotlinType_6(parent, typeMapper).copy_x1fyqk$(void 0, void 0, 'this');
      }
       else if (equals(tmp$_0, SyntaxKind$TypeLiteral))
  ...
  function toKotlinType_6($receiver, typeMapper) {
    ...
    var tmp$_2;
    if ((tmp$_0 = (tmp$ = $receiver.typeParameters) != null ? tmp$ : null) != null) {
      var destination = ArrayList_init(tmp$_0.length);
      var tmp$_3;
      for (tmp$_3 = 0; tmp$_3 !== tmp$_0.length; ++tmp$_3) {
        var item = tmp$_0[tmp$_3];
        destination.add_11rb$(new KtType(unescapeIdentifier(item.name.text)));
      }
      tmp$_2 = destination;
    }
     else
      tmp$_2 = null;
    return new KtType(name, (tmp$_1 = tmp$_2) != null ? tmp$_1 : emptyList());
  }
          ...
          while (tmp$_2.hasNext()) {
            ...
            if (Kotlin.isType(exportedDeclaration, KtVariable)) {
              ...
              if (equals(currentOwner, builder)) {
                exportedDeclaration.name = sanitize(module_0);
              }
            }
          }
        }
    ...
    none$break: do {
      ...
      while (tmp$_0.hasNext()) {
        ...
        any$break: do {
          ...
          while (tmp$_1.hasNext()) {
            var element_0 = tmp$_1.next();
            if (equals(element_0.name, JS_MODULE)) {
              any$result = true;
              break any$break;
            }
          }
  ...
  TsClassifierToKt.prototype.visitHeritageClause_10qtta$ = function (node) {
    ...
    if ((tmp$_0 = (tmp$ = node.types) != null ? tmp$ : null) != null) {
      ...
      for (tmp$_3 = 0; tmp$_3 !== tmp$_0.length; ++tmp$_3) {
        var item = tmp$_0[tmp$_3];
        destination.add_11rb$(new KtHeritageType(stringify(mapType(this.typeMapper, item))));
      }
      tmp$_2 = destination;
    }
     else
  ...
  TsClassifierToKt.prototype.translateAccessor_xriwno$_0 = function (node, isGetter) {
    ...
    while (tmp$.hasNext()) {
      ...
      while (tmp$_5.hasNext()) {
        ...
        var annotation;
        if (isGetter) {
          callSignature = new KtCallSignature(element, emptyList(), new KtTypeAnnotation(element_0.copy_x1fyqk$(void 0, void 0, void 0, true)));
          accessorName = GET;
          annotation = NATIVE_GETTER_ANNOTATION;
        }
         else {
          callSignature = new KtCallSignature(listOf_0([element.get_za3lpa$(0), new KtFunParam('value', new KtTypeAnnotation(element_0))]), emptyList(), new KtTypeAnnotation(new KtType(UNIT)));
          accessorName = SET;
          annotation = NATIVE_SETTER_ANNOTATION;
        }
        this.addFunction_vlhgzl$(null, accessorName, callSignature, void 0, this.needsNoImpl, listOf(annotation), void 0, true);
      }
    }
  };
  ...
  TsClassifierToKt.prototype.visitPropertyDeclaration_qnxew1$ = function (node) {
    ...
    this.getTranslator_uhzyw$(node).addVariable_iel02k$(symbol, name, varType.copy_x1fyqk$(void 0, void 0, void 0, varType.isNullable || this.isNullable_qnxew1$(node)), void 0, void 0, void 0, this.needsNoImpl_qnxew1$(node), void 0, isOverride);
  };
  TsClassifierToKt.prototype.addFunction_h4pyhe$ = function ($receiver, name, isOverride, needsNoImpl, node) {
    ...
    while (tmp$.hasNext()) {
      var element = tmp$.next();
      $receiver.addFunction_vlhgzl$(symbol, name, element, void 0, $receiver.needsNoImpl_7vsj57$(node), void 0, isOverride);
    }
  ...
  TsClassifierToKt.prototype.visitSignatureDeclaration_vb212e$ = function (node) {
    ...
    while (tmp$.hasNext()) {
      var element = tmp$.next();
      this.addFunction_vlhgzl$(null, INVOKE, element, void 0, false, listOf(NATIVE_INVOKE_ANNOTATION), void 0, true);
    }
  };
  ...
  TsInterfaceToKt.prototype.addFunction_h4pyhe$ = function ($receiver, name, isOverride, needsNoImpl, node) {
    ...
    if (isOptional) {
      ...
      $receiver.addVariable_iel02k$(symbol, name, createFunctionType(call.params, call.returnType.type).copy_x1fyqk$(void 0, void 0, void 0, true), void 0, call.typeParams, false, true, void 0, isOverride);
    }
     else {
      var tmp$;
      tmp$ = toKotlinCallSignatureOverloads(node, $receiver.typeMapper).iterator();
      while (tmp$.hasNext()) {
        var element = tmp$.next();
        $receiver.addFunction_vlhgzl$(symbol, name, element, void 0, false, void 0, isOverride);
      }
    }
  };
  ...
  TsInterfaceToKtExtensions.prototype.getExtendsType_t5xv9l$ = function (typeParams) {
    var tmp$;
    return ensureNotNull(this.name) + toString((tmp$ = typeParams != null ? join(typeParams, void 0, void 0, void 0, '<', '>', void 0, getCallableRef('stringify', function ($receiver) {
      return stringify($receiver);
    })) : null) != null ? tmp$ : '');
  };
    ...
    while (tmp$.hasNext()) {
      ...
      while (true) {
        ...
        any$break: do {
          ...
          while (tmp$_1.hasNext()) {
            var element = tmp$_1.next();
            if (equals(element.name, toAdd.v)) {
              any$result = true;
              break any$break;
            }
          }
        ...
        if (!any$result)
          break;
        toAdd.v = e.name + toString((tmp$_0 = i, i = tmp$_0 + 1 | 0, tmp$_0));
      }
  ...
  TsInterfaceToKtExtensions.prototype.addVariable_iel02k$$default = function (symbol, name, type, extendsType, typeParams, isVar, needsNoImpl, additionalAnnotations, isOverride) {
    ...
    this.addVariable_iel02k$(symbol, name, type, actualExtendsType, this.merge_9pzgf3$(typeParamsWithoutClashes, typeParams), isVar, true, annotations, isOverride, TsInterfaceToKt.prototype.addVariable_iel02k$$default.bind(this));
  };
  TsInterfaceToKtExtensions.prototype.addFunction_vlhgzl$$default = function (symbol, name, callSignature, extendsType, needsNoImpl, additionalAnnotations, isOverride, isOperator) {
    var typeParamsWithoutClashes = this.fixIfClashWith_9pzgf3$(this.typeParams, callSignature.typeParams);
    var actualExtendsType = typeParamsWithoutClashes === this.typeParams ? this.cachedExtendsType : this.getExtendsType_t5xv9l$(typeParamsWithoutClashes);
    var annotations = this.withNativeAnnotation_dk8kn7$(additionalAnnotations);
    this.addFunction_vlhgzl$(symbol, name, new KtCallSignature(callSignature.params, this.merge_9pzgf3$(typeParamsWithoutClashes, callSignature.typeParams), callSignature.returnType), actualExtendsType, true, annotations, isOverride, isOperator, TsInterfaceToKt.prototype.addFunction_vlhgzl$$default.bind(this));
  };
  ...
  TypeScriptToKotlin.prototype.visitVariableStatement_x0poxd$ = function (node) {
    ...
    for (tmp$ = 0; tmp$ !== declarations.length; ++tmp$) {
      ...
      this.addVariable_iel02k$(symbol, name, varType, void 0, void 0, void 0, void 0, additionalAnnotations);
    }
  };
  ...
  TypeScriptToKotlin.prototype.visitFunctionDeclaration_eywj3y$ = function (node) {
    ...
    while (tmp$_1.hasNext()) {
      var element = tmp$_1.next();
      this.addFunction_vlhgzl$(symbol, name, element, void 0, void 0, additionalAnnotations);
    }
  ...
  TypeScriptToKotlin.prototype.visitEnumDeclaration_1emvp1$ = function (node) {
    ...
    for (tmp$_0 = 0; tmp$_0 !== $receiver.length; ++tmp$_0) {
      ...
      var tmp$_1;
      destination.add_11rb$(new KtEnumEntry(ensureNotNull(asString_0(item.name)), (tmp$_1 = item.initializer) != null ? tmp$_1.getText() : null));
    }
    var entries = destination;
    var enumClass = new KtClassifier(KtClassKind$ENUM_getInstance(), unescapeIdentifier(node.name.text), emptyList(), emptyList(), emptyList(), entries, emptyList(), false);
    var symbol = (tmp$ = node.name) != null ? getSymbolResolvingAliases(this.typeChecker_0, tmp$) : null;
  ...
  TypeScriptToKotlinBase.prototype.addVariable_iel02k$$default = function (symbol, name, type, extendsType, typeParams, isVar, needsNoImpl, additionalAnnotations, isOverride) {
    var annotations = plus(this.defaultAnnotations, additionalAnnotations);
    this.addDeclaration_ahl69t$(symbol, new KtVariable(name, new KtTypeAnnotation(type), extendsType != null ? new KtHeritageType(extendsType) : null, annotations, typeParams, isVar, needsNoImpl, this.isInterface, isOverride, this.hasMembersOpenModifier));
  };
  TypeScriptToKotlinBase.prototype.addVariable_iel02k$ = function (symbol, name, type, extendsType, typeParams, isVar, needsNoImpl, additionalAnnotations, isOverride, callback$default) {
    if (extendsType === void 0)
      extendsType = null;
    ...
    if (isOverride === void 0)
      isOverride = false;
    callback$default ? callback$default(symbol, name, type, extendsType, typeParams, isVar, needsNoImpl, additionalAnnotations, isOverride) : this.addVariable_iel02k$$default(symbol, name, type, extendsType, typeParams, isVar, needsNoImpl, additionalAnnotations, isOverride);
  };
  TypeScriptToKotlinBase.prototype.addFunction_vlhgzl$$default = function (symbol, name, callSignature, extendsType, needsNoImpl, additionalAnnotations, isOverride, isOperator) {
    var annotations = plus(this.defaultAnnotations, additionalAnnotations);
    this.addDeclaration_ahl69t$(symbol, new KtFunction(name, callSignature, extendsType != null ? new KtHeritageType(extendsType) : null, annotations, needsNoImpl, isOverride, this.hasMembersOpenModifier, isOperator));
  };
  TypeScriptToKotlinBase.prototype.addFunction_vlhgzl$ = function (symbol, name, callSignature, extendsType, needsNoImpl, additionalAnnotations, isOverride, isOperator, callback$default) {
    if (extendsType === void 0)
      extendsType = null;
    if (needsNoImpl === void 0)
      needsNoImpl = true;
    ...
    if (isOperator === void 0)
      isOperator = false;
    callback$default ? callback$default(symbol, name, callSignature, extendsType, needsNoImpl, additionalAnnotations, isOverride, isOperator) : this.addFunction_vlhgzl$$default(symbol, name, callSignature, extendsType, needsNoImpl, additionalAnnotations, isOverride, isOperator);
  };
  ...
  function createClassifier($receiver) {
    return new KtClassifier(KtClassKind$INTERFACE_getInstance(), ensureNotNull($receiver.name), emptyList(), $receiver.typeParams, $receiver.parents, $receiver.declarations, $receiver.annotations, false);
  }
  function createClassifier_0($receiver) {
    ...
    return new KtClassifier($receiver.kind, ensureNotNull($receiver.name), $receiver.paramsOfConstructors, $receiver.typeParams, $receiver.parents, members, $receiver.annotations, $receiver.kind === KtClassKind$CLASS_getInstance());
  }
  var JS_MODULE;
  var JS_QUALIFIER;
  var JS_NAME;
  ...
  function asString_0($receiver) {
    if (equals($receiver.kind, SyntaxKind$Identifier)) {
      return unescapeIdentifier($receiver.text);
    }
     else {
      reportUnsupportedNode($receiver);
  ...
  ObjectTypeToKotlinTypeMapperImpl.prototype.getKotlinTypeForObjectType_29gnwt$ = function (objectType) {
    ...
    var destination_3 = ArrayList_init(collectionSizeOrDefault(typeParams, 10));
    var tmp$_4;
  ...
  function mergeClassifierAndVariable(a, b) {
    ...
    if (a.kind === KtClassKind$INTERFACE_getInstance() || isModule(a)) {
      ...
      var delegation = listOf(new KtHeritageType(varTypeName + ' by ' + NO_IMPL));
      var classObject = new KtClassifier(KtClassKind$COMPANION_OBJECT_getInstance(), '', emptyList(), emptyList(), delegation, emptyList(), emptyList(), false);
  ...
  function mergeClassAndObject(a, b) {
    ...
    if (classObject == null) {
      addMember(a, new KtClassifier(KtClassKind$COMPANION_OBJECT_getInstance(), '', emptyList(), emptyList(), emptyList(), b.members, NO_ANNOTATIONS, false));
    }
     else {
  ...
  function mergeClassesAndPackages($receiver) {
    ...
    while (tmp$.hasNext()) {
      ...
      if (!nestedPackage.nestedPackages.isEmpty())
        continue;
      tmp$_0 = classesByName.get_11rb$(nestedPackage.ownName);
      if (tmp$_0 == null) {
        continue;
      }
      ...
      if (companion == null) {
        companion = new KtClassifier(KtClassKind$COMPANION_OBJECT_getInstance(), '', emptyList(), null, emptyList(), emptyList(), emptyList(), false);
      }
  ...
  function withMissedOverloads_1($receiver) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      var key = element_0.copy_xvy9yo$(void 0, element_0.callSignature.copy_sl5de3$(emptyList()));
      var tmp$_0_0;
    ...
    while (tmp$_8.hasNext()) {
      ...
      while (tmp$_14.hasNext()) {
        ...
        if (((tmp$_15 = m.get_11rb$(element_4.first)) != null ? tmp$_15.contains_11rb$(element_9) : null) !== true) {
          newFunctions.add_11rb$(element_4.first.copy_xvy9yo$(void 0, element_4.first.callSignature.copy_sl5de3$(element_9)));
        }
      }
    }
  ...
  function mapTypeToUnion_0($receiver, type, declaration) {
    ...
    if (equals(declaration != null ? declaration.kind : null, SyntaxKind$ThisType)) {
      ...
      while (tmp$_6.hasNext()) {
        ...
        destination.add_11rb$(item.copy_x1fyqk$(void 0, void 0, 'this'));
      }
                        ...
                        if ((flags & TypeFlags$Union) !== 0) {
                          ...
                          if ((flags & TypeFlags$Intersection) !== 0) {
                            ...
                            if ((flags & TypeFlags$TypeParameter) !== 0)
                              tmp$_3 = KtTypeUnion([new KtType(unescapeIdentifier(ensureNotNull(type.getSymbol()).name))]);
                            else {
  ...
  function mapUnionType($receiver, type) {
    ...
    if (!nullable)
      ...
      while (tmp$_7.hasNext()) {
        ...
        destination_1.add_11rb$(item_0.copy_x1fyqk$(void 0, void 0, void 0, true));
      }
      tmp$ = destination_1;
    }
     else
  ...
  function mapIntersectionType($receiver, type) {
    return KtTypeUnion([mapType_0($receiver, first_0(type.types), null).copy_x1fyqk$(void 0, void 0, joinToString_0(type.types, ' & ', void 0, void 0, void 0, void 0, mapIntersectionType$lambda($receiver)))]);
  }
  ...
  function mapTypeReference($receiver, type, declaration) {
    ...
    return mapObjectType($receiver, type.target).copy_x1fyqk$(void 0, toList_0(mappedArgs));
  }
  function mapInterfaceType($receiver, type, declaration) {
    ...
    if ((tmp$ = type.typeParameters) != null) {
      ...
      tmp$_1 = null;
    var mappedArgs = mapTypeArguments($receiver, (tmp$_0 = tmp$_1) != null ? copyToArray(tmp$_0) : null, declaration);
    var mappedType = mapObjectType($receiver, type);
    if (equals(mappedType.name, 'Function'))
      return mappedType;
    return mappedType.copy_x1fyqk$(void 0, toList_0(mappedArgs));
  }
  ...
  function mapObjectType($receiver, type) {
    ...
    if (equals(fqn, 'Function'))
      return new KtType('Function', listOf(new KtType('*')));
    if (equals(fqn, 'Object'))
      tmp$ = ANY;
    else {
      if ($receiver.currentPackage.length > 0 && startsWith(fqn, $receiver.currentPackage + '.') && indexOf(fqn, 46, $receiver.currentPackage.length + 1 | 0) < 0) {
        var startIndex = $receiver.currentPackage.length + 1 | 0;
        tmp$ = fqn.substring(startIndex);
      }
       else {
        tmp$ = fqn;
      }
  ...
  function buildFqn($receiver, symbol) {
    ...
    return (tmp$_0 = declaration != null ? buildFqn_0($receiver, declaration) : null) != null ? tmp$_0 : escapeIfNeed($receiver.typeChecker.getFullyQualifiedName(symbol));
  }
  function buildFqn_0($receiver, declaration) {
    ...
    if (equals(tmp$_1, SyntaxKind$InterfaceDeclaration) || equals(tmp$_1, SyntaxKind$ClassDeclaration)) {
      return parentName + escapeIfNeed(unescapeIdentifier(ensureNotNull(declaration.name).text));
    }
      ...
      if (equals(tmp$_3, SyntaxKind$StringLiteral)) {
        ...
        tmp$_4 = 'UNKNOWN';
      var name = tmp$_4;
      return parentName + escapeIfNeed(sanitize(name));
    }
    return null;
  }
  ...
  function replaceTypeParameters($receiver, substitution) {
    ...
    if ($receiver.typeArgs.isEmpty() && $receiver.callSignature == null) {
      return (tmp$ = substitution.get_11rb$($receiver.name)) != null ? tmp$ : $receiver;
    }
     else {
      ...
      return $receiver.copy_x1fyqk$(void 0, destination, void 0, void 0, (tmp$_0 = $receiver.callSignature) != null ? replaceTypeParameters_0(tmp$_0, substitution) : null);
    }
  }
  ...
  function replaceTypeParameters_1($receiver, substitution) {
    return $receiver.copy_mgz5iw$(void 0, replaceTypeParameters_2($receiver.type, substitution));
  }
  ...
  function translateToDir(sources, outDir, basePackage, libraries) {
    ...
    while (tmp$.hasNext()) {
      ...
      var packageParts = translate(src, basePackage != null ? basePackage : '');
      if (packageParts.isEmpty()) {
  ...
  function CliArguments(sources, outDir, basePackage, libraries) {
  ...
  CliArguments.prototype.copy_ip32of$ = function (sources, outDir, basePackage, libraries) {
    return new CliArguments(sources === void 0 ? this.sources : sources, outDir === void 0 ? this.outDir : outDir, basePackage === void 0 ? this.basePackage : basePackage, libraries === void 0 ? this.libraries : libraries);
  };
  CliArguments.prototype.toString = function () {
    return 'CliArguments(sources=' + Kotlin.toString(this.sources) + (', outDir=' + Kotlin.toString(this.outDir)) + (', basePackage=' + Kotlin.toString(this.basePackage)) + (', libraries=' + Kotlin.toString(this.libraries)) + ')';
  };
  ...
  CliArguments.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.sources, other.sources) && Kotlin.equals(this.outDir, other.outDir) && Kotlin.equals(this.basePackage, other.basePackage) && Kotlin.equals(this.libraries, other.libraries)))));
  };
  ...
  function parseArguments() {
    ...
    return new CliArguments(sources, destination != null ? destination : '.', basePackage, emptyList());
  }
  function main(args) {
    var tmp$;
  ...
  function translate(srcPath, basePackageName) {
    var tmp$;
    ...
    var typeScriptToKotlin = new TypeScriptToKotlin(context, rootBuilder, typeChecker, rootBuilder.members, DEFAULT_ANNOTATION, SyntaxKind$DeclareKeyword, typeMapper, void 0, translate$lambda(normalizeSrcPath), getCallableRef('isOverride', function (node) {
  ...
  package$ts2kt.translateToDir_ip32of$ = translateToDir;
  ...
  package$ts2kt.translate_puj7f4$ = translate;
